...
class Cell:
    ...
    # перегрузка метода деления как целочисленное деление
    def __truediv__(self, other):
        return f'Деление клеток = {Cell(round(self.quantity // other.quantity))}'

    def make_order(self, cells_count):
        ''' Метод принимает экземпляр класса self и количество ячеек в ряду cells_count
        и позволяет организовать ячейки по рядам. 
