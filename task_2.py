...
# для реализации абстрактного класса добавим модуль abc
...
class Clothes(AbstractClothes):
    ...
    def get_coat_consumption(self):
        return str(f'Расход ткани на пальто размера {self.v} = {self.coat_consumption:.2f}')

    def get_suit_consumption(self):
        return str(f'Расход ткани на костюм для роста {self.h} = {self.suit_consumption:.2f}')
