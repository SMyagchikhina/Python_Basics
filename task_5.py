...
class OfficeEquipment:
    ...
    def __repr__(self):
        return f'{self.name} {self.price} {self.is_color} {self.sheet_format}'
...
class Printer(OfficeEquipment):
    ...
    def __repr__(self):
        return f'{self.name} {self.price} {self.is_color} {self.sheet_format} {self.print_type}'
...
class Scanner(OfficeEquipment):
    ...
    def __repr__(self):
        return f'{self.name} {self.price} {self.is_color} {self.sheet_format} {self.scan_type}'
...
class Copier(OfficeEquipment):
    ...
    def __repr__(self):
        return f'{self.name} {self.price} {self.is_color} {self.sheet_format} {self.copier_type}'


warehouse = Warehouse()
print(warehouse._dict)
# создаем объект и добавляем
printer = Printer('Xerox Phaser 3020', 9990, False, 'A4', 3, 'laser')
